...
- Font files: `assets/fonts/0xProto/`
- Original project: 0xProto by the 0xType Project Authors, https://github.com/0xType/0xProto
- Icon font variant: `0xProtoNerdFont-Regular.ttf` from Nerd Fonts v3.4.0, https://github.com/ryanoasis/nerd-fonts/releases/tag/v3.4.0
- License source: `assets/fonts/0xProto/LICENSE`

```text
Copyright (c) 2026, 0xType Project Authors (https://github.com/0xType)
