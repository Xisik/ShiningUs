...
- License: SIL Open Font License, Version 1.1. The full license text is reproduced below and is also available from the [SIL Open Font License site](https://openfontlicense.org/open-font-license-official-text/).

## SIL Open Font License

The following license applies to the bundled Jayeon Sans font files.
